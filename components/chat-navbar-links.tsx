...
import { AUTH_SIGN_IN_ROUTE, AUTH_SIGN_OUT_ROUTE } from '@/constants/routes';

export const SignOutLinkButton = (): JSX.Element => {
...
export const SignInLinkButton = (): JSX.Element => {
  return (
    <Link
...
export const SignUpLinkButton = (): JSX.Element => {
  return (
    <Link
      href={AUTH_SIGN_IN_ROUTE}
